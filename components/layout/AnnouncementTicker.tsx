    ...
    <span className="inline-flex items-center gap-5 px-5 shrink-0">
      {[FREE_SHIPPING_THRESHOLD_LABEL, ...marqueeItems].map((text) => (
        <span key={text} className="inline-flex items-center gap-5">
          <span className="font-body font-[500] text-[11px] uppercase tracking-[0.12em] text-[#FBFAED]/95 whitespace-nowrap md:text-[12px]">
            {text}
          </span>
          <TickerDot />
        </span>
...
export default function AnnouncementTicker() {
  return (
    ...
    >
      <div className="flex min-h-11 items-center justify-center border-b border-[#FBFAED]/15 bg-[#959d8a] px-4 py-2.5 md:min-h-12 md:py-3">
        <p className="text-center font-body font-[600] text-[12px] uppercase tracking-[0.16em] text-[#FBFAED] md:text-[14px] md:tracking-[0.2em]">
          {FREE_SHIPPING_BELGRADE_LABEL}
        </p>
      </div>
      <div className="h-9 overflow-hidden md:h-10">
